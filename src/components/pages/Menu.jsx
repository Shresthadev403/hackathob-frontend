            ...
            <div className='flex flex-col lg:flex-row justify-between'>
                ...
                <div>
                    ...
                    <div className='flex justify-between flex-wrap max-w-[390px] w-full'>
                        <button onClick={() => filterPrice('1RS')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white border rounded-xl px-5 py-1'>1RS</button>
                        <button onClick={() => filterPrice('100RS')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white border rounded-xl px-5 py-1'>10RS</button>
                        <button onClick={() => filterPrice('1000RS')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white border rounded-xl px-5 py-1'>100RS</button>
                        <button onClick={() => filterPrice('1200RS')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white border rounded-xl px-5 py-1'>1000RS</button>
                    </div>
                </div>
            </div>
